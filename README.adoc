...
[source,sh]
----
➜ git clone https://github.com/jwillikers/pinebook-pro-fedora-installer-image.git
----
...
[source,sh]
----
➜ sudo fish pinebook-pro-fedora-installer-image/pinebook-pro-fedora-installer.fish
----
